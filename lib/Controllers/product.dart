// ignore_for_file: prefer_if_null_operators, prefer_null_aware_operators, unnecessary_new, unnecessary_null_comparison
...
class Welcome {
    ...
    factory Welcome.fromJson(Map<String, dynamic> json) => Welcome(
        id: json["id"],
        brand: brandValues.maps[json["brand"]],
        name: json["name"],
        price: json["price"],
...
class EnumValues<T> {
    ...
    Map<T, String> reverseMap;
     ...
     EnumValues(Map<String, Brand> map, {required this.maps , required this.reverseMap});
